...
class Universe:
    ...
    def _passes_esg_screening(self, constituent: Constituent) -> bool:
        ...
        if esg.min_environmental_score is not None:
            if constituent.environmental_score is None or constituent.environmental_score < esg.min_environmental_score:
                return False
        ...
        if esg.min_governance_score is not None:
            if constituent.governance_score is None or constituent.governance_score < esg.min_governance_score:
                return False
...
class UniverseBuilder:
    ...
    def min_market_cap(self, amount: float, currency: Optional[Currency] = None) -> "UniverseBuilder":
    ...
    def min_average_daily_volume(self, volume: float, currency: Optional[Currency] = None) -> "UniverseBuilder":
