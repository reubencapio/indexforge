...
class Sector(str, Enum):
    ...
    def from_string(cls, value: str) -> "Sector":
        ...
        raise ValueError(
            f"Unknown sector: '{value}'. "
            f"Valid sectors: {', '.join(valid_sectors[:6])}..."
        )
...
REGION_COUNTRIES: dict[Region, list[str]] = {
    ...
    Region.EUROPE: ["GB", "DE", "FR", "IT", "ES", "NL", "CH", "SE", "NO", "DK", "FI", "BE", "AT", "IE", "PT", "PL"],
    Region.ASIA_PACIFIC: ["JP", "CN", "HK", "KR", "TW", "SG", "AU", "NZ", "IN", "ID", "MY", "TH", "PH", "VN"],
