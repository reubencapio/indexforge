        ...
        for ticker in tickers:
            try:
                ...
                constituent = Constituent(
                    ...
                    currency=Currency(info.get('currency', 'USD')) if info.get('currency') in [c.value for c in Currency] else Currency.USD,
                ...
                constituent.free_float_market_cap = constituent.market_cap * constituent.free_float_factor
